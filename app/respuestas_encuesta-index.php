            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="respuestas_encuesta-index.php" class="btn btn-info float-right mr-2">Restablecer vista</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idRespuestaEncuesta'] . "</td>";echo "<td>" . $row['idEncuesta'] . "</td>";echo "<td>" . $row['idPreguntaEncuesta'] . "</td>";echo "<td>" . $row['respuestaSiNo'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='respuestas_encuesta-read.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."' title='Ver Registro' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='respuestas_encuesta-update.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."' title='Actualizar Registro' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='respuestas_encuesta-delete.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."' title='Borrar Registro' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
