...
<head>
    <meta charset="UTF-8">
    <title>Gestión de Respuestas de la Encuesta</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header clearfix">
                        <h2 class="float-left">Respuestas de la Encuesta - Listado General</h2>
                        <a href="respuestas_encuesta-create.php" class="btn btn-success float-right">Crear registro</a>
                            ...
                            echo "<table class='estilo-tabla-index table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td class='centrar-columna'>";
                                        echo "<a href='respuestas_encuesta-read.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."'><i class='far fa-eye'></i></a>";
                                        echo "<a href='respuestas_encuesta-update.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."'><i class='far fa-edit'></i></a>";
                                        echo "<a href='respuestas_encuesta-delete.php?idRespuestaEncuesta=". $row['idRespuestaEncuesta'] ."'><i class='far fa-trash-alt'></i></a>";
                                    echo "</td>";
