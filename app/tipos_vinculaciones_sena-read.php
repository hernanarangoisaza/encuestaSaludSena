            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombreLargoVinculacion" class="form-control" value="<?php echo $row['nombreLargoVinculacion']; ?>" readonly>
                    </div>
                    ...
                    <p><a href="tipos_vinculaciones_sena-index.php" class="btn btn-primary">Volver al listado</a></p>
