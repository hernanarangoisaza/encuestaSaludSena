            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Centros de formación Details</h2>
                        <a href="centros_formacion-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="centros_formacion-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idCentroFormacion'] . "</td>";echo "<td>" . $row['nombreCorto'] . "</td>";echo "<td>" . $row['nombreLargo'] . "</td>";echo "<td>" . $row['direccion'] . "</td>";echo "<td>" . $row['idMunicipio'] . "</td>";echo "<td>" . $row['idDepartamento'] . "</td>";echo "<td>" . $row['telefono1'] . "</td>";echo "<td>" . $row['telefono2'] . "</td>";echo "<td>" . $row['emailContacto1'] . "</td>";echo "<td>" . $row['emailContacto2'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='centros_formacion-read.php?idCentroFormacion=". $row['idCentroFormacion'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='centros_formacion-update.php?idCentroFormacion=". $row['idCentroFormacion'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='centros_formacion-delete.php?idCentroFormacion=". $row['idCentroFormacion'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
