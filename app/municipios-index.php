            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Municipios Details</h2>
                        <a href="municipios-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="municipios-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                    ...
                    $sql = "SELECT * FROM municipios ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idMunicipio'] . "</td>";echo "<td>" . $row['municipio'] . "</td>";echo "<td>" . $row['idDepartamento'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='municipios-read.php?idMunicipio=". $row['idMunicipio'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='municipios-update.php?idMunicipio=". $row['idMunicipio'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='municipios-delete.php?idMunicipio=". $row['idMunicipio'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
