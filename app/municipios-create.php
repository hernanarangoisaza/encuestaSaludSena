 ...
 */
        ...
        $stmt = $pdo->prepare("INSERT INTO municipios (municipio,idDepartamento,estado,auditoria) VALUES (?,?,?,?)"); 
        
        if($stmt->execute([ $municipio,$idDepartamento,$estado,$auditoria  ])) {
                $stmt = null;
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <a href="municipios-index.php" class="btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
