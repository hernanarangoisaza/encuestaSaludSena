...
if(isset($_GET["idTipoGenero"]) && !empty(trim($_GET["idTipoGenero"]))){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id = trim($_GET["idTipoGenero"]);
...
<head>
    <meta charset="UTF-8">
    <title>Ver Tipo de Género</title>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="page-header">
                        <h1>Tipo de Género - Visualizar</h1>
                    </div>
                        
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombreLargoGenero" class="form-control" value="<?php echo $row['nombreLargoGenero']; ?>" readonly>
                    </div>
                    ...
                    <p><a href="tipos_generos-index.php" class="btn btn-primary">Volver al listado</a></p>
