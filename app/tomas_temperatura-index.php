            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tomas de temperatura - Detalle</h2>
                        <a href="tomas_temperatura-create.php" class="btn btn-success float-right">Agregar registro</a>
                        <a href="tomas_temperatura-index.php" class="btn btn-info float-right mr-2">Restablecer vista</a>
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idToma'] . "</td>";echo "<td>" . $row['idEncuesta'] . "</td>";echo "<td>" . $row['fechaHoraTomaEntrada'] . "</td>";echo "<td>" . $row['temperaturaEntrada'] . "</td>";echo "<td>" . $row['fechaHoraTomaSalida'] . "</td>";echo "<td>" . $row['temperaturaSalida'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            ...
                                            echo "<a href='tomas_temperatura-delete.php?idToma=". $row['idToma'] ."' title='Borrar Registro' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
