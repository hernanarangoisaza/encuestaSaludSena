            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tomas de temperatura Details</h2>
                        <a href="tomas_temperatura-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="tomas_temperatura-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=idToma&sort=$sort>Id Toma Temperatura</th>";
										echo "<th><a href=?search=$search&sort=&order=idEncuesta&sort=$sort>Id Encuesta</th>";
										echo "<th><a href=?search=$search&sort=&order=fechaHoraTomaEntrada&sort=$sort>Fecha/hora toma de entrada</th>";
										echo "<th><a href=?search=$search&sort=&order=temperaturaEntrada&sort=$sort>Temperatura a la entrada</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idToma'] . "</td>";echo "<td>" . $row['idEncuesta'] . "</td>";echo "<td>" . $row['fechaHoraTomaEntrada'] . "</td>";echo "<td>" . $row['temperaturaEntrada'] . "</td>";echo "<td>" . $row['fechaHoraTomaSalida'] . "</td>";echo "<td>" . $row['temperaturaSalida'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='tomas_temperatura-read.php?idToma=". $row['idToma'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='tomas_temperatura-update.php?idToma=". $row['idToma'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='tomas_temperatura-delete.php?idToma=". $row['idToma'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
