            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tipos de identificación Details</h2>
                        <a href="tipos_identificacion-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="tipos_identificacion-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idTipoIdentificacion'] . "</td>";echo "<td>" . $row['nombreIdentificacion'] . "</td>";echo "<td>" . $row['nombreCorto'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='tipos_identificacion-read.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='tipos_identificacion-update.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='tipos_identificacion-delete.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
