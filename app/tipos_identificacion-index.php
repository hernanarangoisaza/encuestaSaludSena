...
<head>
    <meta charset="UTF-8">
    <title>Gestión de Tipos de Identificación</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tipos de Identificación - Listado General</h2>
                        <a href="tipos_identificacion-create.php" class="btn btn-success float-right">Crear registro</a>
                        <a href="tipos_identificacion-index.php" class="btn btn-info float-right mr-2">Restablecer listado</a>
                        <a href="index.php" class="btn btn-secondary float-right mr-2">Menú Principal</a>
                    </div>

                    <div class="form-row">
                        <form action="tipos_identificacion-index.php" method="get">
                        <div class="col">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM tipos_identificacion";
                    ...
                    $sql = "SELECT * FROM tipos_identificacion ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                            ...
                            echo "<table class='estilo-tabla-index table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th class='ocultar-columna'><a href=?search=$search&sort=&order=idTipoIdentificacion&sort=$sort>Id Tipo Identificación</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td class='centrar-columna'>";
                                        echo "<a href='tipos_identificacion-read.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."'><i class='far fa-eye'></i></a>";
                                        echo "<a href='tipos_identificacion-update.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."'><i class='far fa-edit'></i></a>";
                                        echo "<a href='tipos_identificacion-delete.php?idTipoIdentificacion=". $row['idTipoIdentificacion'] ."'><i class='far fa-trash-alt'></i></a>";
                                    echo "</td>";
                                    echo "<td class='ocultar-columna'>" . $row['idTipoIdentificacion'] . "</td>";
