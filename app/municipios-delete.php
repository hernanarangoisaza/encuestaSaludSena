...
if(isset($_POST["idMunicipio"]) && !empty($_POST["idMunicipio"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["idMunicipio"]);
    ...
    if(empty(trim($_GET["idMunicipio"]))){
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="page-header">
                        <h1>Municipio - Borrar</h1>
                    </div>

                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="fade-in">
                            <input type="hidden" name="idMunicipio" value="<?php echo trim($_GET["idMunicipio"]); ?>"/>
                            ...
                            <p>
                                ...
                                <a href="municipios-index.php" class="btn btn-secondary">No borrar</a>
                            </p>
                        </div>
                    </form>
