...
<head>
    <meta charset="UTF-8">
    <title>Maestro de Departamentos</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header clearfix">
                        <h2 class="float-left">Departamentos - Panel General</h2>
                        <a href="departamentos-create.php" class="btn btn-success float-right">Crear</a>
