 ...
 */
        ...
        $stmt = $pdo->prepare("INSERT INTO horarios (horaInicial,horaFinal,nombreCorto,estado,auditoria) VALUES (?,?,?,?,?)"); 
        
        if($stmt->execute([ $horaInicial,$horaFinal,$nombreCorto,$estado,$auditoria  ])) {
                $stmt = null;
