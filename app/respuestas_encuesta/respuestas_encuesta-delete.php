...
if(isset($_POST["idRespuestaEncuesta"]) && !empty($_POST["idRespuestaEncuesta"])){
    ...
    $sql = "DELETE FROM respuestas_encuesta WHERE idRespuestaEncuesta = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["idRespuestaEncuesta"]);
    ...
    if(empty(trim($_GET["idRespuestaEncuesta"]))){
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="fade-in">
                            ...
                            <p>
                                ...
                                <a href="respuestas_encuesta-index.php" class="btn btn-secondary">No borrar</a>
                            </p>
                        </div>
                    </form>
