            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Preguntas de la encuesta Details</h2>
                        <a href="preguntas_encuesta-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="preguntas_encuesta-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idPreguntaEncuesta'] . "</td>";echo "<td>" . $row['textoPregunta'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='preguntas_encuesta-read.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='preguntas_encuesta-update.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='preguntas_encuesta-delete.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
