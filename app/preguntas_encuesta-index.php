            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Preguntas de la encuesta - Detalle</h2>
                        <a href="preguntas_encuesta-create.php" class="btn btn-success float-right">Agregar registro</a>
                        <a href="preguntas_encuesta-index.php" class="btn btn-info float-right mr-2">Restablecer vista</a>
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['idPreguntaEncuesta'] . "</td>";echo "<td>" . $row['textoPregunta'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='preguntas_encuesta-read.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='Ver Registro' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='preguntas_encuesta-update.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='Actualizar Registro' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='preguntas_encuesta-delete.php?idPreguntaEncuesta=". $row['idPreguntaEncuesta'] ."' title='Borrar Registro' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
