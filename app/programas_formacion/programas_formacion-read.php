...
if(isset($_GET["idProgramaFormacion"]) && !empty(trim($_GET["idProgramaFormacion"]))){
    ...
    if($stmt = mysqli_prepare($linkMYSQLI, $sql)){
        ...
        // Set parameters
        $param_id = trim($_GET["idProgramaFormacion"]);
...
<head>
    <meta charset="UTF-8">
    <title>Ver Programa de Formación</title>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="page-header">
                        <h1>Programa de Formación - Visualizar</h1>
                    </div>
                        
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombreLargoProgramaFormacion" class="form-control" value="<?php echo $row['nombreLargoProgramaFormacion']; ?>" readonly>
                    </div>
                    ...
                    <p><a href="programas_formacion-index.php" class="btn btn-primary">Volver al listado</a></p>
