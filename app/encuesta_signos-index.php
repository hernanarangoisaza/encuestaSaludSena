            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Encuesta de signos Details</h2>
                        <a href="encuesta_signos-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="encuesta_signos-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idEncuesta'] . "</td>";echo "<td>" . $row['idAprendiz'] . "</td>";echo "<td>" . $row['fechaHoraDiligenciamiento'] . "</td>";echo "<td>" . $row['idSedeIngreso'] . "</td>";echo "<td>" . $row['idHorario'] . "</td>";echo "<td>" . $row['aceptacionConsideraciones'] . "</td>";echo "<td>" . $row['autorizacionTratamientoDatos'] . "</td>";echo "<td>" . $row['autorizacionIngreso'] . "</td>";echo "<td>" . $row['observacionAdicional'] . "</td>";echo "<td>" . $row['aceptacionRespuestaPositiva'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='encuesta_signos-read.php?idEncuesta=". $row['idEncuesta'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='encuesta_signos-update.php?idEncuesta=". $row['idEncuesta'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='encuesta_signos-delete.php?idEncuesta=". $row['idEncuesta'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
