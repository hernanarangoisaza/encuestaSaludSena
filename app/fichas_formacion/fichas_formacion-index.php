...
<head>
    <meta charset="UTF-8">
    <title>Maestro de Fichas de Formación</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Fichas de Formación - Panel General</h2>
                        <a href="fichas_formacion-create.php" class="btn btn-success float-right">Crear</a>
                    ...
                    $orderBy = array('idFichaFormacion', 'codigoFichaFormacion', 'idProgramaFormacion', 'estado', 'auditoria'); 
