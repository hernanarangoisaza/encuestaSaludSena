...
<head>
    <meta charset="UTF-8">
    <title>Maestro de Tipos de Géneros</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tipos de Géneros - Panel General</h2>
                        <a href="tipos_generos-create.php" class="btn btn-success float-right">Crear</a>
                    ...
                    <div class="form-row">
                        <form action="tipos_generos-index.php" method="get">
                        <div class="col">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM tipos_generos";
                    ...
                    $sql = "SELECT * FROM tipos_generos ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                            ...
                            echo "<table class='estilo-tabla-index table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th class='ocultar-columna'><a href=?search=$search&sort=&order=idTipoGenero&sort=$sort>Id Genero</th>";
                                ...
                                while($row = mysqli_fetch_array($resultMSQLI)){
                                    ...
                                    echo "<td class='centrar-columna'>";
                                        echo "<a href='tipos_generos-read.php?idTipoGenero=". $row['idTipoGenero'] ."'><i class='far fa-eye'></i></a>";
                                        echo "<a href='tipos_generos-update.php?idTipoGenero=". $row['idTipoGenero'] ."'><i class='far fa-edit'></i></a>";
                                        echo "<a href='tipos_generos-delete.php?idTipoGenero=". $row['idTipoGenero'] ."'><i class='far fa-trash-alt'></i></a>";
                                    echo "</td>";
                                    echo "<td class='ocultar-columna'>" . $row['idTipoGenero'] . "</td>";
