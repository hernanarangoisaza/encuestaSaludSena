...
if(isset($_POST["idTipoIdentificacion"]) && !empty($_POST["idTipoIdentificacion"])){
    ...
    $sql = "DELETE FROM tipos_identificacion WHERE idTipoIdentificacion = ?";
    ...
    if($stmtPDO = mysqli_prepare($linkMYSQLI, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["idTipoIdentificacion"]);
    ...
    if(empty(trim($_GET["idTipoIdentificacion"]))){
...
<head>
    <meta charset="UTF-8">
    <title>Borrar Tipo de Identificación</title>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="page-header">
                        <h1>Tipo de Identificación - Borrar</h1>
                    </div>

                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="fade-in">
                            <input type="hidden" name="idTipoIdentificacion" value="<?php echo trim($_GET["idTipoIdentificacion"]); ?>"/>
                            ...
                            <p>
                                ...
                                <a href="tipos_identificacion-index.php" class="btn btn-secondary">No borrar</a>
                            </p>
                        </div>
                    </form>
