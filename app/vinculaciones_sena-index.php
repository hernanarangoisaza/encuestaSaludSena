            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Tipos de vinculaciones Details</h2>
                        <a href="vinculaciones_sena-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="vinculaciones_sena-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['idVinculacion'] . "</td>";echo "<td>" . $row['nombreVinculacion'] . "</td>";echo "<td>" . $row['nombreCorto'] . "</td>";echo "<td>" . $row['estado'] . "</td>";echo "<td>" . $row['auditoria'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='vinculaciones_sena-read.php?idVinculacion=". $row['idVinculacion'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='vinculaciones_sena-update.php?idVinculacion=". $row['idVinculacion'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='vinculaciones_sena-delete.php?idVinculacion=". $row['idVinculacion'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
