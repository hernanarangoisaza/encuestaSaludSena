...
<head>
    <meta charset="UTF-8">
    <title>Maestro de Horarios</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Horarios - Panel General</h2>
                        <a href="horarios-create.php" class="btn btn-success float-right">Crear</a>
                        <a href="horarios-index.php" class="btn btn-info float-right mr-2">Restablecer listado</a>
                    ...
                    $orderBy = array('idHorario', 'horaInicial', 'horaFinal', 'nombreCorto', 'jornada', 'estado', 'auditoria'); 
                    $order = 'idHorario';
                            ...
                            echo "<table class='estilo-tabla-index table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th class='ocultar-columna'><a href=?search=$search&sort=&order=idHorario&sort=$sort>Id Horario</th>";
                                ...
                                while($row = mysqli_fetch_array($resultMSQLI)){
                                    ...
                                    echo "<td class='centrar-columna'>";
                                        echo "<a href='horarios-read.php?idHorario=". $row['idHorario'] ."'><i class='far fa-eye'></i></a>";
                                        echo "<a href='horarios-update.php?idHorario=". $row['idHorario'] ."'><i class='far fa-edit'></i></a>";
                                        echo "<a href='horarios-delete.php?idHorario=". $row['idHorario'] ."'><i class='far fa-trash-alt'></i></a>";
                                    echo "</td>";
                                    echo "<td class='ocultar-columna'>" . $row['idHorario'] . "</td>";
                                    echo "<td class='centrar-columna'>" . $row['horaInicial'] . "</td>";
