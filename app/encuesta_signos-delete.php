...
<head>
    <meta charset="UTF-8">
    <title>Borrar Encuesta de Signos</title>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    <div class="page-header">
                        <h1>Encuesta de Signos - Borrar</h1>
                    </div>
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="fade-in">
                            <input type="hidden" name="idEncuesta" value="<?php echo trim($_GET["idEncuesta"]); ?>"/>
                            ...
                            <p>
                                ...
                                <a href="encuesta_signos-index.php" class="btn btn-secondary">No borrar</a>
                            </p>
                        </div>
                    </form>
                </div>
