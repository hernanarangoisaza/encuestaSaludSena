...
<head>
    <meta charset="UTF-8">
    <title>Maestro de Preguntas de la Encuesta</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header clearfix">
                        <h2 class="float-left">Preguntas de la Encuesta - Panel General</h2>
                        <a href="preguntas_encuesta-create.php" class="btn btn-success float-right">Crear</a>
