...
if(isset($_GET["idTipoIdentificacion"]) && !empty(trim($_GET["idTipoIdentificacion"]))){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id = trim($_GET["idTipoIdentificacion"]);
...
<head>
    <meta charset="UTF-8">
    <title>Ver Tipo de Identificación</title>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="page-header">
                        <h1>Tipo de Identificación - Visualizar</h1>
                    </div>
                        
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombreLargoIdentificacion" class="form-control" value="<?php echo $row['nombreLargoIdentificacion']; ?>" readonly>
                    </div>
                    ...
                    <p><a href="tipos_identificacion-index.php" class="btn btn-primary">Volver al listado</a></p>
